...
def read_lines(filename="", nb_lines=0):
    """Read and print n lines of a text file (UTF-8) to stdout.

    Args:
        filename (str, optional): The name of the file to read. Defaults to an empty string.
        nb_lines (int, optional): The number of lines to read and print. Defaults to 0, which means all lines will be read and printed.
